...
public class ObjectFeatureExtraction {
    public static void main(String args[]) throws IOException {
        ...
        String inputImage = "RockClimbing.jpg";
        String outputFolder = "output/";
        String[] IMAGE_CATEGORIES = {"badminton", "polo", "rowing","sailing","RockClimbing"};
        //String[] IMAGE_CATEGORIES = {"elephant", "gazelle", "rhino","zebra"};
